...
`;
    ...
    var ModelType;
    (function (ModelType) {
        ModelType[ModelType["MODEL1_LEVEL1"] = 0] = "MODEL1_LEVEL1";
        ModelType[ModelType["MODEL1_LEVEL2"] = 1] = "MODEL1_LEVEL2";
        ModelType[ModelType["MODEL3"] = 2] = "MODEL3";
    })(ModelType || (ModelType = {}));
    /**
...
.` + gPanelCssClass$1 + `.` + gShownCssClass + ` {
    opacity: 1;
}
...
.` + gPanelCssClass$1 + ` input[type=radio] {
    display: none;
}
...
.` + gPanelCssClass$1 + ` input[type=radio]:enabled + label:hover {
    background-color: #66665A;
}

.` + gPanelCssClass$1 + ` input[type=radio]:disabled + label {
    color: #666;
}

.` + gPanelCssClass$1 + ` input[type=radio]:enabled:checked + label {
    color: #444;
...
.` + gPanelCssClass$1 + ` a.` + gRebootButtonCssClass + `:hover {
